...
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom androidboot.console=ttyMSM0 lpm_levels.sleep_disabled=1 video=vfb:640x400,bpp=32,memsize=3072000 msm_rtb.filter=0x237 ehci-hcd.park=3 service_locator.enable=1 androidboot.usbcontroller=a600000.dwc3 swiotlb=1 loop.max_part=7 androidboot.configfs=true
...
BOARD_DTBOIMG_PARTITION_SIZE := 25165824 # 24576 * 1024
...
BOARD_SUPER_PARTITION_SIZE := 8925478912 # 8716288 * 1024
BOARD_SUPER_PARTITION_GROUPS := motorola_dynamic_partitions
BOARD_MOTOROLA_DYNAMIC_PARTITIONS_SIZE := 4458545152 # (BOARD_SUPER_PARTITION_SIZE / 2) - 4194304
